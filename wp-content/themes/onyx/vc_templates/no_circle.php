...
$args = array_merge($args, $mkdIconCollections->getShortcodeParams());
...
if($background_color != "") {
    if($background_transparency !="") {
        $bg_color = mkd_hex2rgb($background_color);
...
if($title != "" || $text != ""){
    $html .= '<div class="mkd_circle_text_holder  '.$title_alignment.' '.$text_alignment.' " '.$circle_text_holder_style.'>';
