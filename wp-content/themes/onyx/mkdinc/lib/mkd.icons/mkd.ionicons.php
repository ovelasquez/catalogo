...
class MikadoIconsIonIcons implements iIconCollection {
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = MIKADO_ROOT . "/css/ion-icons/css/ionicons.min.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<i class="mkd_icon_ion_icon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
