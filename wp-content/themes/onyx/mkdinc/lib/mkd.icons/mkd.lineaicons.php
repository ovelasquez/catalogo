...
class MikadoIconsLineaIcons implements iIconCollection {
	...
	public function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = MIKADO_ROOT . "/css/linea-icons/style.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<i class="mkd_icon_linea_icon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
