...
class MikadoFramework {
    ...
    private function __construct() {
        $this->mkdOptions = MikadoOptions::get_instance();
        $this->mkdMetaBoxes = MikadoMetaBoxes::get_instance();
    }
	...
	public function setSkin(MikadoSkinAbstract $skinObject) {
		$this->skin = $skinObject;
	}
}

/**
 * Class MikadoSkinManager
 *
...
/**
 * Class MikadoSkinAbstract
 *
 * Abstract class that each skin class must extend
 */
abstract class MikadoSkinAbstract {
    /**
     * @var string
     */
    protected $skinName;
    ...
    public function getMenuIcon($icon) {
		...
		return MIKADO_ROOT.'/img/favicon.ico';
	}
    ...
    public function setShortcodeJSParams() { ?>
		<script>
			window.mkdSCIcon = '<?php echo mkd_get_skin_uri().'/assets/img/admin-logo-icon.png'; ?>';
...
/*
   Class: MikadoAdminPage
   A class that initializes Mikado Admin Page
*/
class MikadoAdminPage implements iLayoutNode {
    ...
    function __construct($slug="", $title="", $icon = "") {
        $this->layout = array();
        $this->factory = new MikadoFieldFactory();
        $this->slug = $slug;
        $this->title = $title;
        $this->icon = $icon;
    }
...
*/
class MikadoMetaBox implements iLayoutNode {
	...
	public function setTitle($label) {
		...
		return $mkdFramework->getSkin()->getSkinLabel().' '.$label;
 	}
}

global $mkdFramework;

$mkdFramework = MikadoFramework::get_instance();
$mkdSkinManager = new MikadoSkinManager();
$mkdFramework->setSkin($mkdSkinManager->getSkin());