...
if( ! class_exists( 'mkd_sidebar' ) ){
	...
	class mkd_sidebar{
		...
		function __construct(){
			...
			$this->title = __('Custom Widget Area','mkd');
		...
		function load_assets(){
			...
			wp_enqueue_script('mkd_sidebar' , MIKADO_ROOT . '/mkdinc/admin/assets/js/mkdf-sidebar.js');
			wp_enqueue_style( 'mkd_sidebar' , MIKADO_ROOT . '/mkdinc/admin/assets/css/mkdf-sidebar.css');
		}
		...
		function template_add_widget_field(){
			...
			echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '".__('Enter Name of the new Widget Area', 'mkd')."' name='mkd-add-widget' /></span>";
			echo "\n    <input class='button' type='submit' value='".__('Add Widget Area', 'mkd')."' />";
			echo "\n    ".$nonce;
			echo "\n  </form>";
			echo "\n</script>\n";
		}
		...
		function register_custom_sidebars(){
			...
			$args = apply_filters('mkd_custom_widget_args', $args);
