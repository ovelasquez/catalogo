...
class Mikado_Latest_Posts extends WP_Widget {
	private $params;
	public function __construct() {
		parent::__construct(
			'mkd_latest_posts_widget', // Base ID
			'Mikado Blog', // Name
			array( 'description' => __( 'Display posts from your blog', 'mkd' ), ) // Args
		);
...
function mkd_latest_posts_widget_load(){
	register_widget('Mikado_Latest_Posts');
}

add_action('widgets_init', 'mkd_latest_posts_widget_load');
