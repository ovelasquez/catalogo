										...
										<li>
											...
											<div class="item_info_holder">
												...
												<div class="item_right">
													...
													<?php echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf('<a href="%s" class="remove" title="%s">&times;</a>', esc_url( $woocommerce->cart->get_remove_url( $cart_item_key ) ), __('Remove this item', 'mkd') ), $cart_item_key ); ?>
...
add_action( 'widgets_init', create_function( '', 'register_widget( "Mikado_Woocommerce_Dropdown_Cart" );' ) );
?>
<?php
