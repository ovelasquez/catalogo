			...
			<?php if (!(isset($mkd_options['show_logo']) && $mkd_options['show_logo'] == "no")){ ?>
				<div class="vertical_logo_wrapper">
					...
					<div class="mkd_logo_vertical" style="height: <?php echo esc_attr(intval($mkd_options['logo_height'])/2); ?>px;">
						<a href="<?php echo esc_url('http://www.epa.biz:81/ve/');  ?>">
			...
			<div class="header_top_bottom_holder">
				...
				<div class="header_bottom <?php echo esc_attr($header_bottom_class) ;?> clearfix <?php if($menu_item_icon_position=="top"){echo 'with_large_icons ';} if($menu_position == "left" && $header_bottom_appearance != "fixed_hiding" && $header_bottom_appearance != "stick menu_bottom" && $header_bottom_appearance != "stick_with_left_right_menu"){ echo 'left_menu_position';} ?>" <?php mkd_inline_style($header_color_per_page); ?> >
					...
					<div class="container">
						...
						<a <?php mkd_inline_style($logo_wrapper_style); ?> href="<?php echo esc_url('http://www.epa.biz:81/ve/'); ?>">
							<img class="hidden-md hidden-lg logo-mobile" style="position:absolute;max-height: 50px;width: 160px;" src="<?php echo esc_url($logo_image_mobile); ?>" alt="Logo"/> </a>
							...
							<div class="header_inner_right" style="margin-left: 20px;">
								...
								<?php if (!(isset($mkd_options['show_logo']) && $mkd_options['show_logo'] == "no")){ ?>
									<div class="logo_wrapper" <?php mkd_inline_style($logo_wrapper_style); ?>>
										...
										<img class="normal" src="<?php echo esc_url($logo_image); ?>" style="height: 100%;max-height: 50px;" alt="Logo"/>
											...
											<img class="mobile hidden-xs hidden-sm" src="<?php echo esc_url($logo_image_mobile); ?>" alt="Logo"/>
											
											<?php if($enable_popup_menu == 'yes'){ ?><img class="popup" src="<?php echo esc_url($logo_image_popup); ?>" alt="Logo"/><?php } ?>
											</a>
										</div>
										<?php if($header_bottom_appearance == "fixed_hiding") { ?>
											<div class="mkd_logo_hidden"><a href="<?php echo esc_url('http://www.epa.biz:81/ve/'); ?>">
											<img alt="Logo" src="<?php echo esc_url($logo_image_fixed_hidden); ?>" style="height: 100%;"></a></div>
										<?php } ?>
									</div>
								<?php } ?>
							...
							<div class="header_inner_center">
								...
								<?php if (!(isset($mkd_options['show_logo']) && $mkd_options['show_logo'] == "no")){ ?>
									<div class="logo_wrapper" <?php mkd_inline_style($logo_wrapper_style); ?>>
										...
										<img class="dark" src="<?php echo esc_url($logo_image_dark); ?>" alt="Logo"/>
										<img class="sticky" src="<?php echo esc_url($logo_image_sticky); ?>" alt="Logo"/>
										<img class="mobile" src="<?php echo esc_url($logo_image_mobile); ?>" alt="Logo"/>
										<?php if($enable_popup_menu == 'yes'){ ?>
											<img class="popup" src="<?php echo esc_url($logo_image_popup); ?>" alt="Logo"/>
										<?php } ?>
										</a>
										</div>
						...
						<div class="header_inner_left">
							...
							<?php if (!(isset($mkd_options['show_logo']) && $mkd_options['show_logo'] == "no")){ ?>
								<div class="logo_wrapper" <?php mkd_inline_style($logo_wrapper_style); ?>>
									...
									<img class="sticky" src="<?php echo esc_url($logo_image_sticky); ?>" alt="Logo"/>
									<img class="mobile" src="<?php echo esc_url($logo_image_mobile); ?>" alt="Logo"/>
									<?php if($enable_popup_menu == 'yes'){ ?><img class="popup" src="<?php echo esc_url($logo_image_popup); ?>" alt="Logo"/>
									<?php } ?>
									</a>
									</div>
