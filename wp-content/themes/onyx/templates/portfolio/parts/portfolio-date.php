...
$portfolio_hide_date = "";
if(isset($mkd_options['portfolio_hide_date'])){
	$portfolio_hide_date = $mkd_options['portfolio_hide_date'];
}
...
if($portfolio_hide_date != "yes"){
   ...
   ?>
	...
	<div class="info portfolio_single_custom_date">
		<<?php echo esc_attr($portfolio_info_tag); ?> class="info_section_title" <?php mkd_inline_style($portfolio_info_style); ?>><?php _e('Date','mkd'); ?></<?php echo esc_attr($portfolio_info_tag); ?>>
